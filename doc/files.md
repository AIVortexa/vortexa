...
* vortexa.conf: contains configuration settings for vortexad or vortexa-qt
* vortexad.pid: stores the process id of vortexad while running
...
* debug.log: contains debug information and general logging generated by vortexad or vortexa-qt
