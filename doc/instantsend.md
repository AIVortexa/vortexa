...
This mechanism has been integrated into Bitcore-Node-Vortexa which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AIVortexa/insight-api-vortexa#web-socket-api](https://github.com/AIVortexa/insight-api-vortexa#web-socket-api)
* API: [https://github.com/AIVortexa/insight-api-vortexa#instantsend-transactions](https://github.com/AIVortexa/insight-api-vortexa#instantsend-transactions)
