...
This document provides guidelines for internationalization of the Vortexa Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vortexa_en.ts` remains unchanged.
