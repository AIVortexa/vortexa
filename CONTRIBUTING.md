Contributing to Vortexa Core
============================

The Vortexa Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/AIVortexa/vortexa/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Vortexa Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Vortexa
Network Protocol consensus changes.

Whether a pull request is merged into Vortexa Core rests with the project merge
...
Patches that change Vortexa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vortexa consensus, it must have been
...
The review process is normally fairly responsive on the Vortexa Core repository, however
...
The project leader is the release manager for each Vortexa Core release.
