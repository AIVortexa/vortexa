...
// Copyright (c) 2019-2021 The Vortexa Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VORTEXA_UNORDERED_LRU_CACHE_H
#define VORTEXA_UNORDERED_LRU_CACHE_H
...
#endif // VORTEXA_UNORDERED_LRU_CACHE_H
