...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vortexa address"));
    ...
    privateSendCoinsAction->setStatusTip(tr("PrivateSend coins to a Vortexa address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vortexa: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Vortexa Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vortexa addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vortexa addresses"));
    ...
    openAction->setStatusTip(tr("Open a vortexa: URI or payment request"));

    showHelpMessageAction = new QAction(tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Vortexa command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vortexa network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the vortexa logo
...
{
    QString strTitle = tr("Vortexa Core"); // default title
