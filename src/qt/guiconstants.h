...
/* VortexaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* VortexaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Vortexa"
#define QAPP_ORG_DOMAIN "aivortexa.com"
#define QAPP_APP_NAME_DEFAULT "Vortexa-Qt"
#define QAPP_APP_NAME_TESTNET "Vortexa-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Vortexa-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Vortexa-Qt-regtest"
