...
/** Utility functions used by the Vortexa Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vortexa:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load vortexa specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a vortexa specific theme is activated (light/dark).*/
