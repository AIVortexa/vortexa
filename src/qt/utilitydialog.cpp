    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  vortexa-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Vortexa in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 VOA, 0.01 VOA, 0.1 VOA, 1 VOA and 10 VOA -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://vortexa-coin.readthedocs.io/en/stable/introduction/features.html#instantsend\">PrivateSend documentation</a>."
