...
official/supported Docker Images found at https://hub.docker.com/r/AIVortexa/vortexad/
...
**NOTE: Please update the image description at https://hub.docker.com/r/AIVortexa/vortexad-develop/ when changing the above text**