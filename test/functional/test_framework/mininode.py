...
"""Vortexa P2P network half-a-node.
...
MAGIC_BYTES = {
    "mainnet": b"\xa1\xb2\xc3\xd4",   # mainnet
    "testnet3": b"\xd1\x2b\xb3\x7a",  # testnet3
    "regtest": b"\xa1\xb3\xd5\x7b",   # regtest
    "devnet": b"\x2e\xca\xff\xce",    # devnet
}
...
class P2PConnection(asyncore.dispatcher):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest", devnet_name=None):
        ...
        logger.debug('Connecting to Vortexa Node: %s:%d' % (self.dstaddr, self.dstport))
