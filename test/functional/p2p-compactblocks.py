...
# TestNode: A peer we use to send messages to vortexad, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes vortexad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vortexad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vortexad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vortexad will not send blocktxn responses for blocks whose height is
