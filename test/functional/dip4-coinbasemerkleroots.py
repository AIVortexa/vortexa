...
from test_framework.test_framework import VortexaTestFramework
...
class LLMQCoinbaseCommitmentsTest(VortexaTestFramework):
    def set_test_params(self):
        self.set_vortexa_test_params(4, 3, fast_dip3_enforcement=True)
        self.set_vortexa_dip8_activation(200)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as VortexaTestFramework doesn't support this atm)
